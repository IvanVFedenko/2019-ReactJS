...
const List = React.createClass ({
  ...
  handleInputSearch(e) {
    ...
    this.setState({
      students: STUDENTS.filter(student => student.name.toLowerCase().indexOf(search.toLowerCase()) !== -1)
    });
  },
    ...
    return (
      <div>
        <div className="container_1">
          ...
          <input placeholder = "Search..." id="search" onChange = {this.handleInputSearch}/>
        </div>
